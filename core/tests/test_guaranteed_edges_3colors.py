...
from core.cycle_cover import even_odd_1_cycle, get_connected_cycle_cover
from core.helper_operations.cycle_cover_generation import incorporated_odd_2_1_cycle
...
class Test_GuaranteedEdges_Even_2_1_subcycles:
    def test_guaranteed_edges_Odd_2_1(self):
        for odd_val in [3, 5, 9, 13]:
            ...
            # test_guaranteed_stutter_cross_edge unused
            node_18 = (1, 1) + (0,) * (odd_val - 1) + (2, 0)
            node_19 = (1, 0, 1) + (0,) * (odd_val - 2) + (2, 0)
    ...
    def test_guaranteed_edges_alternative_Odd_2_1(self):
        odd_val = 3
        cc = incorporated_odd_2_1_cycle(odd_val, True)
        # guaranteed_top_row
        for i in range(0, odd_val, 2):
            index_1 = cc.index((0,) * (i) + (1,) + (0,) * (odd_val - i) + (1, 2))
            index_2 = cc.index(
            ...
            assert abs(index_1 - index_2) == 1 or abs(index_1 - index_2) == len(cc) - 1
        ...
        index_9 = cc.index(node_9)
        index_10 = cc.index(node_10)
        assert abs(index_9 - index_10) == 1 or abs(index_9 - index_10) == len(cc) - 1
        ...
        index_11 = cc.index(node_11)
        index_12 = cc.index(node_12)
        assert abs(index_11 - index_12) == 1 or abs(index_11 - index_12) == len(cc) - 1
        ...
        index_13 = cc.index(node_13)
        index_14 = cc.index(node_14)
        assert abs(index_13 - index_14) == 1 or abs(index_13 - index_14) == len(cc) - 1
        ...
        index_15 = cc.index(node_15)
        index_16 = cc.index(node_16)
        assert abs(index_15 - index_16) == 1 or abs(index_15 - index_16) == len(cc) - 1

        # test_guaranteed_top_right_two_down
        node_17 = (0,) * (odd_val) + (1, 1, 2)
        index_17 = cc.index(node_17)
        # reuses node_16
        assert abs(index_17 - index_16) == 1 or abs(index_17 - index_16) == len(cc) - 1

        # test_guaranteed_stutter_cross_edge_unused
        node_18 = (0, 0, 1, 1, 2, 0)
        node_19 = (0, 1, 0, 1, 2, 0)
        index_18 = cc.index(node_18)
        index_19 = cc.index(node_19)
...
class Test_GuaranteedEdges_Even_Odd_1:
    def test_guaranteed_edges_Even_Odd_1(self):
        ...
        for even_val_0 in [4, 6, 8]:
            for odd_val_1 in range(3, even_val_0 + 1, 2):
                ...
                # test_guaranteed_stutter_cross_edge_unused
                node_21 = (1,) * (odd_val_1 - 1) + (0,) * (even_val_0) + (2, 1)
                node_22 = (
                    (1,) * (odd_val_1 - 2) + (0, 1) + (0,) * (even_val_0 - 1) + (2, 1)
                )
                index_21 = cc.index(node_21)
                index_22 = cc.index(node_22)
                assert (
                    abs(index_21 - index_22) == 1
                    or abs(index_21 - index_22) == len(cc) - 1
                )

    def test_guaranteed_edges_alternative_Even_Odd_1(self):
        # even is larger than odd
        for even_val_0 in [4, 6, 8]:
            for odd_val_1 in range(3, even_val_0 + 1, 2):
                if even_val_0 == 8 and odd_val_1 > 3:
                    break
                print(f"computing even-odd {(even_val_0, odd_val_1, 1)}")
                cc = even_odd_1_cycle((even_val_0, odd_val_1, 1), False)
                ...
                # test_guaranteed_stutter_cross_edge_unused
                node_21 = (0,) * (even_val_0) + (1,) * (odd_val_1 - 1) + (2, 1)
                node_22 = (
                    (0,) * (even_val_0 - 1) + (1, 0) + (1,) * (odd_val_1 - 2) + (2, 1)
                )
                index_21 = cc.index(node_21)
                index_22 = cc.index(node_22)
                assert (
    ...
    def test_guaranteed_edges_Odd_Even_1(self):
        ...
        for odd_val_0 in [5, 7]:
            ...
            # test_guaranteed_stutter_cross_edge
            node_8 = (1,) * (even_val_1) + (0,) * (odd_val_0 - 1) + (2, 0)
            node_9 = (1,) * (even_val_1) + (0,) * (odd_val_0 - 2) + (2, 0, 0)
            index_8 = cc.index(node_8)
            index_9 = cc.index(node_9)
            ...
            # test_guaranteed_stutter_cross_edge_unused
            node_24 = (0,) * (odd_val_0 - 1) + (1,) * (even_val_1) + (2, 0)
            node_25 = (0,) * (odd_val_0 - 2) + (1, 0) + (1,) * (even_val_1 - 1) + (2, 0)
            index_24 = cc.index(node_24)
            index_25 = cc.index(node_25)
            assert (
                abs(index_24 - index_25) == 1 or abs(index_24 - index_25) == len(cc) - 1
            )

    def test_guaranteed_edges_alternative_Odd_Even_1(self):
        # odd is larger than even
        for odd_val_0 in [5, 7]:
            even_val_1 = 4
            print(f"computing even-odd {(odd_val_0, even_val_1, 1)}")
            cc = even_odd_1_cycle((odd_val_0, even_val_1, 1), False)
            ...
            # test_guaranteed_stutter_cross_edge_unused
            node_24 = (1,) * (even_val_1) + (0,) * (odd_val_0 - 1) + (2, 0)
            node_25 = (1,) * (even_val_1 - 1) + (0, 1) + (0,) * (odd_val_0 - 2) + (2, 0)
            index_24 = cc.index(node_24)
            index_25 = cc.index(node_25)
            assert (
                abs(index_24 - index_25) == 1 or abs(index_24 - index_25) == len(cc) - 1
