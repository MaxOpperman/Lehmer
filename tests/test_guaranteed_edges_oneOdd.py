...
class Test_GuaranteedEdges_One_Odd_Length_3:
        ...
        for odd_val_0 in [3, 5, 7, 9]:
            for even_val_1 in range(2, odd_val_0 + 1, 2):
                for even_val_2 in range(2, even_val_1 + 1, 2):
                    if (odd_val_0 == 9 and even_val_1 >= 4) or (odd_val_0 == 7 and even_val_2 >= 4):
                        break
                    ...
                    node_2 = (
                        (1,) * (even_val_1) + (0,) * (odd_val_0 - 1) + (2, 0) + (2,) * (even_val_2 - 1)
                    )
                    assert (
                    ...
                    node_4 = (
                        (2,) * (even_val_2) + (0,) * (odd_val_0 - 1) + (1, 0) + (1,) * (even_val_1 - 1)
                    )
                    assert (
        ...
        for even_val_0 in [4, 6, 8]:
            for odd_val_1 in range(3, even_val_0 + 1, 2):
                for even_val_2 in range(2, odd_val_1 + 1, 2):
                    ...
                    node_2 = (
                        (0,) * (even_val_0) + (1,) * (odd_val_1 - 1) + (2, 1) + (2,) * (even_val_2 - 1)
                    )
                    assert (
                        abs(cyc.index(node_1) - cyc.index(node_2)) == 1
                        or abs(cyc.index(node_1) - cyc.index(node_2)) == len(cyc) - 1
                    ...
                    node_4 = (
                        (2,) * (even_val_2) + (1,) * (odd_val_1 - 1) + (0, 1) + (0,) * (even_val_0 - 1)
                    )
                    assert (
                        abs(cyc.index(node_3) - cyc.index(node_4)) == 1
                        or abs(cyc.index(node_3) - cyc.index(node_4)) == len(cyc) - 1
    ...
    def test_guaranteed_edges_Even_Even_Odd(self):
        ...
        for even_val_0 in [4, 6, 8]:
            ...
            # guaranteed swap at odds
            node_1 = (
                (0,) * (even_val_0) + (2,) * (odd_val_2) + (1,) * (even_val_1)
            )
            node_2 = (
                (0,) * (even_val_0) + (2,) * (odd_val_2 - 1) + (1, 2) + (1,) * (even_val_1 - 1)
            )
            assert (
                abs(cyc.index(node_1) - cyc.index(node_2)) == 1
                or abs(cyc.index(node_1) - cyc.index(node_2)) == len(cyc) - 1
            ...
            # and the other one with evens swapped
            node_3 = (
                (1,) * (even_val_1) + (2,) * (odd_val_2) + (0,) * (even_val_0)
            )
            node_4 = (
                (1,) * (even_val_1) + (2,) * (odd_val_2 - 1) + (0, 2) + (0,) * (even_val_0 - 1)
            )
            assert (
                abs(cyc.index(node_3) - cyc.index(node_4)) == 1
                or abs(cyc.index(node_3) - cyc.index(node_4)) == len(cyc) - 1
    ...
    def test_guaranteed_edges_Odd_2_2_2(self):
        ...
        for odd_val_0 in [3, 5, 7]:
            ...
            # Guaranteed edge 1
            # guaranteed swap at odds
            cyc = get_connected_cycle_cover((odd_val_0, even_val_1, even_val_2, even_val_3))

            node_1 = (
                (1,) * (even_val_1) + (2,) * (even_val_2) + (0,) * (odd_val_0) + (3,) * (even_val_3)
            )
            node_2 = (
                (1,) * (even_val_1) + (2,) * (even_val_2) + (0,) * (odd_val_0 - 1) + (3, 0) + (3,) * (even_val_3 - 1)
            )
            assert (
                abs(cyc.index(node_1) - cyc.index(node_2)) == 1
                or abs(cyc.index(node_1) - cyc.index(node_2)) == len(cyc) - 1
            ...
            # and the other one with evens swapped
            node_3 = (
                (2,) * (even_val_2) + (1,) * (even_val_1) + (0,) * (odd_val_0) + (3,) * (even_val_3)
            )
            node_4 = (
                (2,) * (even_val_2) + (1,) * (even_val_1) + (0,) * (odd_val_0 - 1) + (3, 0) + (3,) * (even_val_3 - 1)
            )
            assert (
                abs(cyc.index(node_3) - cyc.index(node_4)) == 1
                or abs(cyc.index(node_3) - cyc.index(node_4)) == len(cyc) - 1
            ...
            node_5 = (
                (3,) * (even_val_3) + (2,) * (even_val_2) + (0,) * (odd_val_0) + (1,) * (even_val_1)
            )
            node_6 = (
                (3,) * (even_val_3) + (2,) * (even_val_2) + (0,) * (odd_val_0 - 1) + (1, 0) + (1,) * (even_val_1 - 1)
            )
            assert (
            ...
            node_7 = (
                (2,) * (even_val_2) + (3,) * (even_val_3) + (0,) * (odd_val_0) + (1,) * (even_val_1)
            )
            node_8 = (
                (2,) * (even_val_2) + (3,) * (even_val_3) + (0,) * (odd_val_0 - 1) + (1, 0) + (1,) * (even_val_1 - 1)
            )
            assert (
            ...
            node_9 = (
                (3,) * (even_val_3) + (1,) * (even_val_1) + (0,) * (odd_val_0) + (2,) * (even_val_2)
            )
            node_10 = (
                (3,) * (even_val_3) + (1,) * (even_val_1) + (0,) * (odd_val_0 - 1) + (2, 0) + (2,) * (even_val_2 - 1)
            )
            assert (
            ...
            node_11 = (
                (1,) * (even_val_1) + (3,) * (even_val_3) + (0,) * (odd_val_0) + (2,) * (even_val_2)
            )
            node_12 = (
                (1,) * (even_val_1) + (3,) * (even_val_3) + (0,) * (odd_val_0 - 1) + (2, 0) + (2,) * (even_val_2 - 1)
            )
            assert (
